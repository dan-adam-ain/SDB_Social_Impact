                ...
                <Link href={`/blog/${post.slug}`} className="block h-full">
                  <article className="card overflow-hidden h-full group flex flex-col cursor-pointer">
                    <div className="p-6 flex flex-col flex-grow">
                      <span className="text-[#3B8EA5] text-sm font-semibold uppercase tracking-wider">
                        {post.category}
                      </span>
                      <h2 className="font-serif text-xl mt-2 mb-3 group-hover:text-[#3B8EA5] transition-colors">
                        {post.title}
                      </h2>
                      <p className="text-[#3B8EA5] text-sm mb-4 flex-grow">{post.excerpt}</p>
                      <div className="flex justify-between items-center text-sm text-[#3B8EA5]">
                        <span>{post.date}</span>
          ...
          <div className="max-w-2xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <input
                ...
                className="px-4 py-3 bg-[#F7F8FA] border border-[#2F3A44]/20 rounded-lg focus:outline-none focus:border-[#3B8EA5] text-[#2F3A44] placeholder-[#3B8EA5] transition-colors"
              />
