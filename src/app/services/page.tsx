  ...
  return (
    <div>
      ...
      <section className="py-24 px-4 relative overflow-hidden">
        <div className="absolute top-1/4 right-1/4 w-96 h-96 bg-[#3B8EA5]/10 rounded-full blur-3xl" />
        <AnimateIn>
            ...
            <div className="card p-8 md:p-12">
              ...
              <div className="grid md:grid-cols-2 gap-6 mb-6">
                <div className="bg-[#E6E8EB] rounded-lg p-6">
                  <h3 className="font-semibold text-[#3B8EA5] mb-3">Why Funders Want It</h3>
                  <ul className="space-y-2 text-[#3B8EA5] text-sm">
                    <li className="flex items-start gap-2">
                      <span className="text-[#3B8EA5] mt-1">•</span>
                ...
                <div className="bg-[#E6E8EB] rounded-lg p-6">
                  <h3 className="font-semibold text-[#3B8EA5] mb-3">What You&apos;ll Learn</h3>
                  <ul className="space-y-2 text-[#3B8EA5] text-sm">
                    <li className="flex items-start gap-2">
                      <span className="text-[#3B8EA5] mt-1">•</span>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-12 items-start">
            <AnimateIn direction="left">
              <div>
                <span className="text-[#3B8EA5] text-sm font-semibold uppercase tracking-wider">Service 01</span>
                ...
                <ul className="space-y-3 mb-8">
                  <li className="flex items-start">
                    <svg className="w-5 h-5 text-[#3B8EA5] mr-3 mt-1 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                ...
                <div className="bg-[#E6E8EB] rounded-lg p-4 mb-6">
                  <p className="text-sm text-[#3B8EA5]">
            ...
            <AnimateIn delay={200} direction="right">
              <div className="card p-8 sticky top-8">
                <div className="text-center mb-8">
                  <p className="text-[#3B8EA5] text-sm font-semibold uppercase tracking-wider mb-2">Get Started</p>
                ...
                <p className="text-center text-[#3B8EA5] text-xs mt-4">No obligation. No pressure.</p>
              </div>
            </AnimateIn>
          </div>
        </div>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-12 items-start">
            <AnimateIn direction="left" className="lg:order-2">
              <div>
                <span className="text-[#3B8EA5] text-sm font-semibold uppercase tracking-wider">Service 02</span>
