            ...
            <div className="card p-8 md:p-12">
              <div className="flex items-start gap-6 mb-6">
                ...
                <div>
                  ...
                  <p className="text-[#a0a0a0] mb-4">
                    <strong className="text-white">Social Return on Investment (SROI)</strong> is an internationally recognized
              ...
              <div className="grid md:grid-cols-2 gap-6 mb-6">
                <div className="bg-white/5 rounded-lg p-6">
                  <h3 className="font-semibold text-[#c9a962] mb-3">Why Funders Want It</h3>
                ...
                <div className="bg-white/5 rounded-lg p-6">
                  <h3 className="font-semibold text-[#c9a962] mb-3">What You&apos;ll Learn</h3>
                  <ul className="space-y-2 text-[#a0a0a0] text-sm">
                    <li className="flex items-start gap-2">
                      <span className="text-[#c9a962] mt-1">•</span>
              ...
              <p className="text-[#a0a0a0] text-sm">
                <strong className="text-white">Example:</strong> A workforce development program might show that for every $1 invested,
              ...
              <div>
                ...
                <ul className="space-y-3 mb-8">
                  <li className="flex items-start">
                    ...
                    <span><strong className="text-white">Discovery & Scoping</strong> — Define objectives and stakeholder groups</span>
                  </li>
                  <li className="flex items-start">
                    <svg className="w-5 h-5 text-[#c9a962] mr-3 mt-1 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                    </svg>
                    <span><strong className="text-white">Stakeholder Interviews</strong> — Capture outcomes from those you serve</span>
                  </li>
                  <li className="flex items-start">
                    <svg className="w-5 h-5 text-[#c9a962] mr-3 mt-1 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                    </svg>
                    <span><strong className="text-white">Impact Mapping</strong> — Build your theory of change with measurable outcomes</span>
                  </li>
                  <li className="flex items-start">
                    <svg className="w-5 h-5 text-[#c9a962] mr-3 mt-1 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                    </svg>
                    <span><strong className="text-white">Valuation & Analysis</strong> — Calculate your SROI ratio using proven methodologies</span>
                  </li>
                  <li className="flex items-start">
                    <svg className="w-5 h-5 text-[#c9a962] mr-3 mt-1 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                    </svg>
                    <span><strong className="text-white">Final Report</strong> — Professional, funder-ready documentation</span>
                  </li>
                  <li className="flex items-start">
                    <svg className="w-5 h-5 text-[#c9a962] mr-3 mt-1 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                    </svg>
                    <span><strong className="text-white">Presentation Support</strong> — Help communicating findings to your board and funders</span>
                  </li>
                </ul>

                <div className="bg-white/5 rounded-lg p-4 mb-6">
                  <p className="text-sm text-[#a0a0a0]">
                    <strong className="text-[#c9a962]">Typical Timeline:</strong> 8-12 weeks depending on scope and stakeholder availability
                  </p>
                </div>
              </div>
            </AnimateIn>
            <AnimateIn delay={200} direction="right">
              <div className="card p-8 sticky top-8">
                <div className="text-center mb-8">
                  <p className="text-[#c9a962] text-sm font-semibold uppercase tracking-wider mb-2">Get Started</p>
                ...
                <p className="text-center text-[#a0a0a0] text-xs mt-4">No obligation. No pressure.</p>
              </div>
            </AnimateIn>
          </div>
        </div>
              ...
              <div>
                ...
                <ul className="space-y-3 mb-8">
                  <li className="flex items-start">
                    ...
                    <span><strong className="text-white">Monthly Retainer</strong> — Ongoing partnership, typically 10-20 hours/month</span>
                  </li>
                  <li className="flex items-start">
                    <svg className="w-5 h-5 text-[#c9a962] mr-3 mt-1 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                    </svg>
                    <span><strong className="text-white">Strategic Planning</strong> — Develop and execute your operational roadmap</span>
                  </li>
                  <li className="flex items-start">
                    <svg className="w-5 h-5 text-[#c9a962] mr-3 mt-1 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                    </svg>
                    <span><strong className="text-white">Team Development</strong> — Build leadership capacity across your organization</span>
                  </li>
                  <li className="flex items-start">
                    <svg className="w-5 h-5 text-[#c9a962] mr-3 mt-1 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                    </svg>
                    <span><strong className="text-white">Process Improvement</strong> — Streamline operations for greater efficiency</span>
                  </li>
                  <li className="flex items-start">
                    <svg className="w-5 h-5 text-[#c9a962] mr-3 mt-1 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                    </svg>
                    <span><strong className="text-white">Executive Coaching</strong> — Support for your leadership team</span>
                  </li>
                  <li className="flex items-start">
                    <svg className="w-5 h-5 text-[#c9a962] mr-3 mt-1 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                    </svg>
                    <span><strong className="text-white">Accountability Partner</strong> — Keep initiatives on track and moving forward</span>
                  </li>
                </ul>

                <div className="bg-white/5 rounded-lg p-4 mb-6">
                  <p className="text-sm text-[#a0a0a0]">
                    <strong className="text-[#c9a962]">Ideal For:</strong> Organizations in transition, rapid growth, or seeking to stabilize operations before a major initiative
                  </p>
                </div>
              </div>
            </AnimateIn>
