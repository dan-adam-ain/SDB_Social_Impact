  ...
  return (
    <div>
      ...
      <section className="min-h-[90vh] flex items-center justify-center px-4 relative overflow-hidden">
        ...
        <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-[#3B8EA5]/10 rounded-full blur-3xl" />
        <div className="absolute bottom-1/4 right-1/4 w-80 h-80 bg-[#3B8EA5]/5 rounded-full blur-3xl" />
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          <AnimateIn delay={200}>
            <p className="text-xl md:text-2xl text-[#3B8EA5] mb-8 max-w-2xl mx-auto">
      ...
      <section className="section-gradient py-24 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <AnimateIn delay={300}>
            <p className="text-xl md:text-2xl text-[#3B8EA5] font-semibold leading-relaxed">
            ...
            <AnimateIn direction="left">
              <div>
                <h2 className="font-serif text-3xl md:text-4xl mb-6">
                  Hi, I&apos;m <span className="gradient-text">Stacey D. Burns</span>
                </h2>
                <p className="text-lg text-[#3B8EA5] mb-6 leading-relaxed">
                  I&apos;ve spent 15+ years helping mission-driven organizations stop spinning their wheels and start seeing real results.
                </p>
                <p className="text-lg text-[#3B8EA5] leading-relaxed">
              ...
              <div className="card p-8">
                ...
                <ul className="space-y-4">
                  <li className="flex items-start gap-3">
                    <svg className="w-6 h-6 text-[#3B8EA5] flex-shrink-0 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <section className="section-gradient py-24 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <AnimateIn delay={100}>
            <p className="text-xl text-[#3B8EA5] mb-8 max-w-2xl mx-auto">
