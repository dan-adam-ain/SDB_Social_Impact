    ...
    <div>
      ...
      <section className="section-gradient py-24 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <AnimateIn delay={300}>
            <p className="text-xl md:text-2xl text-[#c9a962] font-semibold leading-relaxed">
              ...
              <div className="card p-8">
                ...
                <ul className="space-y-4">
                  <li className="flex items-start gap-3">
                    <svg className="w-6 h-6 text-[#c9a962] flex-shrink-0 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                    </svg>
                    <span className="text-[#e0e0e0]">Your mission drives everything we do</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <svg className="w-6 h-6 text-[#c9a962] flex-shrink-0 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                    </svg>
                    <span className="text-[#e0e0e0]">Simple systems beat complicated ones</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <svg className="w-6 h-6 text-[#c9a962] flex-shrink-0 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                    </svg>
                    <span className="text-[#e0e0e0]">If you can&apos;t measure it, you can&apos;t improve it</span>
                  </li>
                </ul>
              </div>
            </AnimateIn>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <AnimateIn delay={100}>
              <div className="card p-8 h-full">
                ...
                <div>
                  <p className="font-semibold text-[#c9a962]">Maria Chen</p>
                  <p className="text-sm text-[#a0a0a0]">Executive Director, Community First Initiative</p>
                </div>
              </div>
            </AnimateIn>
            <AnimateIn delay={200}>
              <div className="card p-8 h-full">
                ...
                <div>
                  <p className="font-semibold text-[#c9a962]">James Rodriguez</p>
                  <p className="text-sm text-[#a0a0a0]">Program Director, Urban Youth Alliance</p>
                </div>
              </div>
            </AnimateIn>
          </div>
