  ...
  return (
    <div>
      ...
      <section className="py-24 px-4 relative overflow-hidden">
        <div className="absolute top-1/3 left-1/4 w-80 h-80 bg-[#3B8EA5]/10 rounded-full blur-3xl" />
        <AnimateIn>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <AnimateIn direction="left">
              <div>
                <span className="text-[#3B8EA5] text-sm font-semibold uppercase tracking-wider">Founder</span>
                <h2 className="font-serif text-3xl md:text-4xl mt-2 mb-6">Stacey D. Burns</h2>
                <p className="text-[#3B8EA5] mb-4">
            ...
            <AnimateIn delay={100} direction="left">
              <div className="card p-8 h-full">
                <div className="icon-container w-14 h-14 rounded-xl flex items-center justify-center mb-6">
                  <svg className="w-7 h-7 text-[#3B8EA5]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M13 10V3L4 14h7v7l9-11h-7z" />
                  </svg>
                </div>
                <h3 className="font-serif text-2xl mb-4">Our Mission</h3>
                <p className="text-[#3B8EA5]">
            ...
            <AnimateIn delay={100}>
              <div className="text-center group">
                <div className="icon-container w-16 h-16 mx-auto mb-4 rounded-full flex items-center justify-center">
                  <svg className="w-8 h-8 text-[#3B8EA5]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" />
                  </svg>
                </div>
                <h3 className="font-semibold mb-2">Healthcare</h3>
                <p className="text-[#3B8EA5] text-sm">Community health centers, hospitals, and health-focused nonprofits</p>
              </div>
            </AnimateIn>
            <AnimateIn delay={150}>
              <div className="text-center group">
                ...
                <p className="text-[#3B8EA5] text-sm">Affordable housing organizations and community development</p>
              </div>
            </AnimateIn>
            <AnimateIn delay={200}>
              <div className="text-center group">
                ...
                <p className="text-[#3B8EA5] text-sm">Museums, theaters, and cultural institutions</p>
              </div>
            </AnimateIn>
            <AnimateIn delay={250}>
              <div className="text-center group">
                ...
                <p className="text-[#3B8EA5] text-sm">Schools, educational nonprofits, and youth programs</p>
              </div>
            </AnimateIn>
            <AnimateIn delay={300}>
              <div className="text-center group">
                ...
                <p className="text-[#3B8EA5] text-sm">Mission-driven businesses and hybrid organizations</p>
              </div>
            </AnimateIn>
            <AnimateIn delay={350}>
              <div className="text-center group">
                ...
                <p className="text-[#3B8EA5] text-sm">Social services and community support organizations</p>
              </div>
            </AnimateIn>
          </div>
        </div>
      ...
      <section className="py-24 px-4 relative overflow-hidden">
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="w-[500px] h-[500px] bg-[#3B8EA5]/5 rounded-full blur-3xl" />
        </div>
        <AnimateIn>
          <div className="max-w-4xl mx-auto text-center relative z-10">
            <h2 className="font-serif text-3xl md:text-4xl mb-6">Ready to Start Your Journey?</h2>
            <p className="text-xl text-[#3B8EA5] mb-8">
