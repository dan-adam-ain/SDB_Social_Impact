  ...
  return (
    <div>
      ...
      <section className="py-24 px-4 relative overflow-hidden">
        <div className="absolute top-1/3 left-1/4 w-80 h-80 bg-[#c9a962]/10 rounded-full blur-3xl" />
        <AnimateIn>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <AnimateIn delay={200} direction="right">
              <div className="card p-8">
                <div className="w-32 h-32 mx-auto mb-6 rounded-full bg-gradient-to-br from-[#c9a962] to-[#8a7343] flex items-center justify-center">
                  <span className="font-serif text-3xl font-bold text-[#0a0a0a]">SDB</span>
                </div>
